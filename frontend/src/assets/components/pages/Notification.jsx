                ...
                >
                  <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                    ...
                    <Link
                      ...
                      className="shrink-0 w-full md:w-auto text-center bg-slate-100 dark:bg-slate-800 group-hover:bg-blue-600 hover:text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-500"
                    >
                      Xem chi tiết
